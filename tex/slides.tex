  ...
  \tikzset{
    ...
    drug grey/.pic={%
      \shadedraw [
        grey-palatinate,
        pic actions,
        top color=grey-palatinate!80!white,
        bottom color=grey-palatinate!80!black,
      ] (0,#1/2)
        -- (#1/2,#1/2)
        arc (90:-90:#1/2)
        -- (0,-#1/2)
        ...
        \begin{figure}[h]
          ...
          \begin{tikzpicture}
            ...
            \matrix [anchor=base,align=center] {%
              ...
              \node {\alert{\emph{peg}ylated}\\\alert{liposome}}; &
...
\begin{frame}{\autotitle}
  \begin{columns}
    \column{0.5\textwidth}
      \begin{example}
        \begin{figure}[h]
          ...
          \caption{Liposomes with thermosensitive polymers for diffusive release~\footcitemark{ta2013thermosensitive}}
        \end{figure}
      \end{example}
    ...
    \column{0.5\textwidth}
      ...
      \end{block}
  \end{columns}
  \footcitetext{ta2013thermosensitive}
\end{frame}
