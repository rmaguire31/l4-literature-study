      ...
      \begin{block}{Nanocarrier structure}
        \begin{figure}
          ...
          \begin{tikzpicture}[%
            ...
            \begin{scope}
              \clip (0,0) -- (\angEl/2-90:\R) arc (\angEl/2-90:270-\angEl/2:\R) -- cycle;
            ...
            \foreach \t in {60,120} {%
              ...
              \begin{scope}
                ...
                \foreach \i in {1,...,10}
                  \pic [rotate=rand*180] at (rand*\R/4,rand*\R/4) {drug={\R/5}};
              \end{scope}
              \begin{scope}[line cap=round,draw=pale-palatinate]
                  \DrawLongitudeArc[\R]{\t};
              \end{scope}
            }
            \foreach \t in {-60,-30,...,240}
              \pic [rotate=\t] at (\t:\R) {ligand=\R/3};
            \node [anchor=west] (nanoparticle) at (45:1.5*\R) {nanoparticle};
            \node [anchor=west,align=left] (ligand) at (0:1.5*\R) {targeting\\ligand};
            \node [anchor=west] (drug) at (-45:1.5*\R) {active drug};

            \draw [->,dirt-palatinate] (nanoparticle.west) -- (45:\R);
            \draw [->,dirt-palatinate] (ligand.west) -- (0:4/3*\R);
            \draw [->,dirt-palatinate] (drug.west) -- (-45:\R/4);
          \end{tikzpicture}
        \end{figure}
      \end{block}
