\documentclass[aspectratio=169,compress]{beamer}
  ...
  \setbeamercolor*{block body example}{parent=normal text,bg=gold-palatinate!5}
          ...
          \begin{tikzpicture}
            ...
            \begin{scope}
              \clip (0,0)
                ...
                -- cycle;
              \shadedraw [palatinate,ultra thick,ball color=palatinate] (0,0) circle (\R);
            \end{scope}
            \foreach \t in {\angLatA,\angLatB} {%
              ...
              \begin{scope}
                ...
                \foreach \i in {1,...,30}
                  \pic [rotate=rand*180] at (rand*180:rand^2*\R/2) {drug=\R/6};
              \end{scope}
          ...
          \begin{tikzpicture}
            ...
            \matrix [%
              ...
              \foreach \t in {15,30,...,360}
                \pic [rotate=\t] at (\t:\R) {fatty acid=\R/3};
              \foreach \i in {1,...,30}
                \pic [rotate=rand*180,very thin] at (rand*180:rand^2*\R/2) {drug=\R/6};

              &&

              \foreach \t in {20,40,...,360}
                \pic [rotate=180+\t] at (\t:2/3*\R) {fatty acid=\R/3};
              \foreach \t in {10,20,...,360}
                \pic [rotate=\t+5] at (\t+5:4/3*\R) {fatty acid=\R/3};
              \foreach \i in {1,...,30}
                \pic [rotate=rand*180,very thin] at (rand*180:rand^2*\R/2) {drug=\R/6};
              ...
              \foreach \t in {10,20,...,360} {%
                \pic [palatinate,rotate=180+\t] at (\t:\R) {peg=\R/3};
              ...
              \shadedraw [%
                ...
                decorate,
                decoration={random steps,segment length=\R/2,amplitude=\R/2},
                rounded corners=\R/10,
              ] (0,0) circle (\R);
              \foreach \x in {{-\R},\R}
                \pic [rotate=rand*180,very thin] at (\x,0) {drug=\R/2};
        ...
        \begin{columns}[t,onlytextwidth]
          \column{0.55\textwidth}\vskip-1em
            \begin{itemize}
              ...
              \item \alert{Not immunogenic}\hskip-5em
            \end{itemize}
      ...
      \begin{block}{How is targeted drug delivery effective?}
        \begin{figure}
          ...
          \begin{tikzpicture}[%
            ...
            \foreach \x in {1,...,50}
              \pic [rotate=rand*180] at ($(1.5*2em*rand,2em*rand)+(healthy general)$) {drug=0.3em};
            \foreach \x in {1,...,5}
              \pic [rotate=rand*180] at ($(1.5*2em*rand,2em*rand)+(healthy targeted)$) {drug=0.3em};
            ...
            \foreach \x in {51,...,100}
              \pic [rotate=rand*180] at ($(1.5*2em*rand,2em*rand)+(diseased general)$) {drug=0.3em};
            \foreach \x in {6,...,100}
              \pic [rotate=rand*180] at ($(1.5*2em*rand,2em*rand)+(diseased targeted)$) {drug=0.3em};
