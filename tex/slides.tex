            ...
            fatty acid/.pic={%
              \foreach \t in {175,185}
                \draw [
                  palatinate,
                  decorate,
                  decoration={snake,segment length=#1/4,amplitude=#1/16},
                ] (0,0) -- (\t:#1);
              \filldraw [palatinate,ball color=palatinate] (0,0) circle (#1/4);
            }
          ]
            \foreach \t in {15,30,...,360}
              \pic [rotate=180+\t] at (\t:1em) {fatty acid=0.5em};

            \foreach \t in {10,20,...,360} {
              \pic [rotate=\t] at (\t:1.5em) {fatty acid=0.5em};
            }
