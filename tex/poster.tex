    ...
    \column{0.325\textwidth}
      \begin{block}{Active targeting\strut}
        \begin{figure}
          ...
          \caption{Receptor-mediator endocytosis. In order: nanocarrier binding~\tikznum{1}, endocytosis~\tikznum{2}, endosome transport~\tikznum{3}, and drug release~\tikznum{4}}
        \end{figure}
